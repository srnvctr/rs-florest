    ...
    <header className="AdminNavbar-Container">
      ...
      <IonList className="AdminNavbar-List">
        <IonItem
          ...
          className={
            activeItem === "/admin/service" ? "AdminNavbar-Active" : ""
          }
        >
        ...
        <IonItem
          ...
          className={activeItem === "/admin/doctor" ? "AdminNavbar-Active" : ""}
        >
        ...
        <IonItem
          ...
          className={
            activeItem === "/admin/appointment" ? "AdminNavbar-Active" : ""
          }
        >
        ...
        <IonItem onClick={handleLogout} style={{ cursor: "pointer" }}>
